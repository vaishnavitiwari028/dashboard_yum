...
import { logoDarkImg } from "../../assets/images/images";
import { notificationsData } from "../../mock_data/notificationData";

const Header = () => {
  return (
    <header className="sticky top-0 z-40 flex h-18 w-full border-b border-default-200 bg-white dark:bg-default-50 lg:ps-64 hide-in-print p-2">
