...
import { logoDarkImg, offerBgOtherImg } from "../../assets/images/images";
...
const Sidebar = () => {
  return (
    ...
    >
      <div className="sticky top-0 flex h-18 items-center justify-center border-b border-dashed border-default-200 px-6 p-6">
        <div>
          <img
            src={logoDarkImg}
            height={40}
      ...
      <ul className="flex flex-col gap-2 px-4 pt-10">
        ...
        <li>
          <div className="flex items-center gap-x-3.5 rounded-md px-4 py-3 text-sm text-default-700 hover:bg-default-100">
            <LuUserCircle2 size={20} />
            Profile
          </div>
        </li>
        <li>
          <div className="flex items-center gap-x-3.5 rounded-md px-4 py-3 text-sm text-red-500 hover:bg-red-400/10 hover:text-red-600">
            <LuLogOut size={20} />
            Logout
          </div>
        </li>
