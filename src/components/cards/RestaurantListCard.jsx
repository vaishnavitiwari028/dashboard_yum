    ...
    <div className="relative rounded-lg border border-default-200 p-6">
      ...
      <div className="mb-8 flex justify-around">
        <div className="text-center">
          <h4 className="mb-2.5 text-lg font-medium text-amber-500">
            {total_dishes}
          </h4>
      ...
      <div className="text-center">
        <button
          className="inline-flex rounded-lg bg-amber-500 px-8 py-2.5 font-medium text-white transition-all hover:bg-primary-500"
        >
          View Details
        </button>
      </div>
